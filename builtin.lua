...
npc.proc.register_program("npc:follow", {
	...
	{name = "npc:jump_if", args = {expr = {left = "@args.reach_distance", op = "==", right = nil}, offset = true, negate = true, pos = 1}}, -- IF [3],
		{name = "npc:var:set", args = {key = "reach", value = 1, storage_type = "local"}},
	{key = "@local.target_pos", name = "npc:obj:get_pos", args = {object = "@args.object"}},
	{name = "npc:jump_if", args = {expr = {left = "@local.target_pos", op = "~=", right = nil}, offset = true, negate = true, pos = 6}}, -- IF [6],
		{key = "@local._inline0", name = "npc:distance_to", args = {pos = "@local.target_pos"}},
		{name = "npc:jump_if", args = {expr = {left = "@local._inline0", op = "<", right = "@local.reach"}, offset = true, negate = true, pos = 3}}, -- IF [2],
